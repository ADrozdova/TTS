...
class FastSpeech(BaseModel):
    def __init__(self, vocab_size, enc_layers, in_size, n_heads, hidden, kernels, padding, dp_in_size, dp_hidden,
        ...
        self.encoder = FFT(enc_layers, in_size, n_heads, hidden, kernels, padding, attn_dropout=attn_dropout,
                           dropout=dropout)
        self.emb = nn.Embedding(vocab_size, in_size, padding_idx=0)
